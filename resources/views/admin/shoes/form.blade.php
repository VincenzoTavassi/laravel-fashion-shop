    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="@error('brand') is-invalid @enderror form-control" id="brand" name="brand"
            value="{{ old('brand', $shoe->brand) }}">
          @error('brand')
        ...
        <div class="mb-3">
          ...
          <input type="number" step="0.01" class="form-control @error('price') is-invalid @enderror" id="price"
            name="price" value="{{ old('price', $shoe->price) }}">
          @error('price')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
        ...
        <div class="mb-3">
          ...
          <input type="checkbox" class="form-check-control @error('is_available') is-invalid @enderror" id="is_available"
            name="is_available" value="1" @checked(old('is_available', $shoe->is_available))>
          @error('is_available')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
        ...
        <div class="mb-3">
          <button type="submit" class="btn btn-primary">{{ $shoe->id ? 'Modifica' . $shoe->title : 'Salva' }}</button>
        </div>
